      ...
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        >
          <p className="text-lg text-[#AAB3BE] leading-relaxed mb-6">
            I am currently a <span className="font-bold text-[#F0BE6F]">Software Developer</span>, passionate about crafting clean, scalable, and efficient applications. 
            Currently pursuing my <span className="font-bold text-[#F0BE6F]">Master’s in Computer Science at Syracuse University</span>, 
